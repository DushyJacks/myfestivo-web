...
export default function SignupPage() {
  ...
  return (
      ...
      <motion.div variants={pageItem} className="w-full max-w-lg">
        ...
        <GlassCard className="p-8">
          {/* Continue with Google — shown first for easy access */}
          <Button
            type="button"
            ...
            className="w-full bg-white/[0.05] border border-white/[0.1] text-white hover:bg-white/[0.1] font-medium h-12 transition-colors mb-6"
          >
            {googleLoading ? (
              <span className="inline-flex items-center gap-2">
          ...
          <div className="mb-6 flex items-center gap-4" aria-hidden="true">
            ...
            <span className="text-[10px] font-mono tracking-widest uppercase text-white/40">or sign up with email</span>
            <div className="flex-1 h-px bg-white/[0.08]" />
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5" noValidate>
            ...
            {form.role === "student" && (
              <>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label htmlFor="rollNo" className="text-[11px] font-mono tracking-widest uppercase text-white/75 mb-2 block">Roll Number <span className="text-red-400">*</span></label>
