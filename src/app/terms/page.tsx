  ...
  return (
    <main className="min-h-screen bg-[var(--color-bg)] px-6 md:px-16 py-24 max-w-3xl mx-auto">
      ...
      <header className="mb-16">
        ...
        <h1 className="text-4xl font-extralight tracking-tight text-[var(--color-text)] mb-4">Terms &amp; Conditions</h1>
        <p className="text-[var(--color-text-muted)] text-sm font-mono">Effective Date: July 5, 2026 · Last Updated: July 5, 2026</p>
      </header>

      {/* Content */}
      <div className="space-y-10 text-[var(--color-text-muted)] text-sm leading-relaxed">

        <Section title="1. Acceptance of Terms">
          <p>
            Welcome to <strong className="text-[var(--color-text)]">MyFestivo</strong> (&quot;Platform,&quot; &quot;we,&quot; &quot;us,&quot; &quot;our,&quot; or &quot;Company&quot;). MyFestivo is an online event
          ...
          <p>
            ...
            <a href="https://myfestivo.live" className="text-[var(--color-accent)] hover:underline">https://myfestivo.live</a>{" "}
        ...
        <Section title="3. Organizer Responsibilities">
          <Subsection title="3.1 Full Responsibility for Events">
            ...
            <ul className="list-disc pl-5 space-y-1.5">
              <li><strong className="text-[var(--color-text)]">Event Planning &amp; Execution:</strong> Planning, organizing, coordinating, and conducting all aspects of the event.</li>
              <li><strong className="text-[var(--color-text)]">Compliance with Laws:</strong> Ensuring the event complies with all applicable Indian laws, local regulations, and college policies.</li>
              <li><strong className="text-[var(--color-text)]">Safety &amp; Security:</strong> Ensuring the safety, security, and well-being of all Participants.</li>
              <li><strong className="text-[var(--color-text)]">Liability &amp; Insurance:</strong> Assuming full legal and financial liability for any accidents, injuries, damages, or claims arising from the event.</li>
              <li><strong className="text-[var(--color-text)]">Attendance Verification:</strong> Verifying that Participants meet the eligibility criteria for the event.</li>
              <li><strong className="text-[var(--color-text)]">Cancellations &amp; Changes:</strong> Notifying Participants promptly of any cancellations, postponements, reschedulings, or significant changes to the event.</li>
              <li><strong className="text-[var(--color-text)]">Collection of Participant Data:</strong> Responsibly managing and protecting any personal information collected from Participants (names, emails, phone numbers, etc.).</li>
            </ul>
          </Subsection>
          <Subsection title="3.2 Indemnification">
            <p className="mb-2">Organizers agree to <strong className="text-[var(--color-text)]">indemnify, defend, and hold harmless</strong> MyFestivo, its founders, employees, and agents from any and all claims, damages, losses, liabilities, and expenses (including legal fees) arising from:</p>
            <ul className="list-disc pl-5 space-y-1">
          ...
          <Subsection title="3.3 Event Content &amp; Descriptions">
            <p>Organizers must provide <strong className="text-[var(--color-text)]">accurate, truthful, and non-misleading</strong> event descriptions. Misleading event information may result in account suspension or permanent ban.</p>
          </Subsection>
        </Section>
        ...
        <Section title="4. Participant Rights &amp; Responsibilities">
          <Subsection title="4.1 Participant Responsibilities">
            ...
            <ul className="list-disc pl-5 space-y-1.5">
              <li><strong className="text-[var(--color-text)]">Follow Event Guidelines:</strong> Comply with all rules, instructions, and guidelines set by the Organizer.</li>
              <li><strong className="text-[var(--color-text)]">Respectful Conduct:</strong> Treat all attendees, organizers, and volunteers with respect. Harassment, hate speech, discrimination, or abusive behavior is strictly prohibited.</li>
              <li><strong className="text-[var(--color-text)]">Accurate Information:</strong> Provide accurate and truthful information during registration.</li>
              <li><strong className="text-[var(--color-text)]">Legal Compliance:</strong> Engage in activities that comply with all applicable laws and college policies.</li>
              <li><strong className="text-[var(--color-text)]">No Reselling:</strong> You may not resell, transfer, or distribute your event registration to another person.</li>
            </ul>
          </Subsection>
        ...
        <Section title="5. Prohibited Activities">
          ...
          <Subsection title="5.1 Event-Related Violations">
            <ul className="list-disc pl-5 space-y-1.5">
              <li>Creating or promoting <strong className="text-[var(--color-text)]">commercial or non-educational events</strong> (events focused on profit generation rather than learning or community building).</li>
              <li>Organizing events that <strong className="text-[var(--color-text)]">violate Indian laws</strong>, local regulations, or institutional policies.</li>
              <li>Reselling or transferring event registrations.</li>
              <li>Organizing events that promote <strong className="text-[var(--color-text)]">violence, illegal activities, harassment, hate speech, discrimination, or harm</strong> to any person or group.</li>
            </ul>
          </Subsection>
          <Subsection title="5.2 Platform Conduct Violations">
            <ul className="list-disc pl-5 space-y-1.5">
              <li>Engaging in <strong className="text-[var(--color-text)]">harassment, hate speech, discrimination, bullying, or abusive behavior</strong> towards other users.</li>
              <li>Sharing <strong className="text-[var(--color-text)]">sexually explicit, obscene, or illegal content</strong>.</li>
              <li>Creating <strong className="text-[var(--color-text)]">fake, misleading, or fraudulent accounts</strong>.</li>
              <li>Attempting to <strong className="text-[var(--color-text)]">hack, breach, disrupt, or damage</strong> the Platform or its systems.</li>
              <li>Spam, automated bots, or malicious activity.</li>
              <li>Attempting to <strong className="text-[var(--color-text)]">circumvent security measures</strong> or access unauthorized portions of the Platform.</li>
            </ul>
          </Subsection>
          <Subsection title="5.3 Consequences">
            <p className="mb-2">Users who violate these prohibitions will be subject to:</p>
            <ul className="list-disc pl-5 space-y-1">
              <li><strong className="text-[var(--color-text)]">Immediate account suspension</strong> (temporary or permanent).</li>
              <li><strong className="text-[var(--color-text)]">Removal from all events</strong> they have registered for or organized.</li>
              <li><strong className="text-[var(--color-text)]">Referral to relevant authorities</strong> if the violation involves illegal activity.</li>
            </ul>
          </Subsection>
        </Section>
        ...
        <Section title="6. Intellectual Property Rights">
          ...
          <Subsection title="6.2 User-Generated Content">
            <p className="mb-2">You retain ownership of event descriptions, images, and other content you create (&quot;User Content&quot;). However, you grant MyFestivo a <strong className="text-[var(--color-text)]">perpetual, worldwide, royalty-free, non-exclusive license</strong> to:</p>
            <ul className="list-disc pl-5 space-y-1">
              <li>Use, reproduce, modify, and display your event information for Platform operations.</li>
              <li><strong className="text-[var(--color-text)]">Use event data and descriptions for marketing, analytics, and competitive research</strong> (including SEO content generation and blog posts comparing MyFestivo to competitors).</li>
        ...
        <Section title="7. Disclaimer of Warranties">
          <p>MyFestivo is provided on an <strong className="text-[var(--color-text)]">&quot;AS IS&quot; and &quot;AS AVAILABLE&quot;</strong> basis without warranties of any kind, express or implied.</p>
          <Subsection title="7.1 Specific Disclaimers">
            <p className="mb-2">We make <strong className="text-[var(--color-text)]">no representations or warranties</strong> regarding:</p>
            <ul className="list-disc pl-5 space-y-1.5">
              <li><strong className="text-[var(--color-text)]">Accuracy or Completeness:</strong> Event information, descriptions, or details provided by Organizers.</li>
              <li><strong className="text-[var(--color-text)]">Reliability or Uninterrupted Access:</strong> The Platform may be subject to downtime, errors, or interruptions without liability.</li>
              <li><strong className="text-[var(--color-text)]">Security:</strong> While we implement reasonable security measures, we cannot guarantee absolute protection against breaches or unauthorized access.</li>
              <li><strong className="text-[var(--color-text)]">Third-Party Services:</strong> Firebase, email providers, college authentication systems, or other integrations may fail without our liability.</li>
              <li><strong className="text-[var(--color-text)]">Fitness for Purpose:</strong> The Platform may not meet all your specific requirements.</li>
            </ul>
          </Subsection>
        </Section>
        ...
        <Section title="8. Limitation of Liability">
          <Subsection title="8.1 Liability Cap">
            <p><strong className="text-[var(--color-text)]">MyFestivo&apos;s total liability to any user is limited to zero rupees (₹0).</strong> MyFestivo shall not be liable for any damages, losses, or claims, regardless of the cause.</p>
          </Subsection>
          <Subsection title="8.2 Exclusions of Liability">
            <p className="mb-2">MyFestivo is <strong className="text-[var(--color-text)]">NOT liable</strong> for:</p>
            <ul className="list-disc pl-5 space-y-1.5">
              <li><strong className="text-[var(--color-text)]">Direct or Indirect Damages:</strong> Including lost profits, revenue, data, business opportunities, or reputational harm.</li>
              <li><strong className="text-[var(--color-text)]">Consequential, Incidental, or Special Damages:</strong> Even if MyFestivo has been advised of the possibility of such damages.</li>
              <li><strong className="text-[var(--color-text)]">Third-Party Actions:</strong> Failures, breaches, or misconduct of third-party services (email providers, authentication systems, college servers, etc.).</li>
              <li><strong className="text-[var(--color-text)]">Event-Related Losses:</strong> Any injury, damage, illness, or loss occurring during or related to events organized through the Platform.</li>
              <li><strong className="text-[var(--color-text)]">Data Loss or Unauthorized Access:</strong> We are not liable if your data is compromised, lost, or accessed without authorization, except in cases of our gross negligence or willful misconduct.</li>
            </ul>
          </Subsection>
        ...
        <Section title="11. Privacy &amp; Data Collection">
          <p>MyFestivo collects, uses, and stores user data as described in the <strong className="text-[var(--color-text)]">separate Privacy Policy</strong> available on the Platform. Your use of the Platform constitutes acceptance of our{" "}
